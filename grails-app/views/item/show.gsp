	...
	<body>
		...
		<div id="show-item" class="content scaffold-show" role="main">
			...
			<ol class="property-list item">
				...
				<g:if test="${itemInstance?.orderHistory}">
				<li class="fieldcontain">
					<span id="orderHistory-label" class="property-label"><g:message code="item.orderHistory.label" default="Order History" /></span>
					
						<span class="property-value" aria-labelledby="orderHistory-label"><g:link controller="orderHistory" action="show" id="${itemInstance?.orderHistory?.id}">${itemInstance?.orderHistory?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="createdBy-label" class="property-label"><g:message code="item.createdBy.label" default="Created By" /></span>
						...
						<span class="property-value" aria-labelledby="createdBy-label"><g:link controller="user" action="show" id="${itemInstance?.createdBy?.id}">${itemInstance?.createdBy?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="lastUpdatedBy-label" class="property-label"><g:message code="item.lastUpdatedBy.label" default="Last Updated By" /></span>
						...
						<span class="property-value" aria-labelledby="lastUpdatedBy-label"><g:link controller="user" action="show" id="${itemInstance?.lastUpdatedBy?.id}">${itemInstance?.lastUpdatedBy?.encodeAsHTML()}</g:link></span>
